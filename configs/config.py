...
OPENAI_FILTER_DATA_STRUCTURER_MODEL = str(
    os.getenv("OPENAI_FILTER_DATA_STRUCTURER_MODEL")
)
OPENAI_LOCATION_VERIFIER_MODEL = str(os.getenv("OPENAI_LOCATION_VERIFIER_MODEL"))
