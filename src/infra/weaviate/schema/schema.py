...
from src.domain.schemas.messages.messages import create_messages_vectordb_schema
...
class WeaviateSchemasManagement():
    ...
    def create_collections(
        ...
        create_messages_vectordb_schema(client=self._weaviate_client, logger=self._logger)
